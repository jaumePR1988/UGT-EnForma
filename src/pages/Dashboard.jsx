        ...
        <div className="bg-background-light text-slate-900 min-h-screen transition-colors duration-200">
            ...
            <main className="lg:ml-64 p-6 lg:p-10 transition-all duration-200">
                <header className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                    <div>
                        <h1 className="text-2xl font-bold text-slate-800">{t('dashboard.title', "Panell d'Administració")}</h1>
                        <p className="text-slate-500">{t('dashboard.subtitle', "Gestió global de la formació sindical")}</p>
                    </div>
                    ...
                    <div className="space-y-6">
                        <div className="bg-white rounded-xl border border-slate-200 shadow-sm">
                            ...
                            <div className="p-6">
                                ...
                                <button className="w-full mt-6 py-2 text-sm font-medium text-slate-500 hover:text-primary transition-colors border border-dashed border-slate-300 rounded-lg">
            ...
            <footer className="lg:ml-64 p-6 border-t border-slate-200 text-center">
